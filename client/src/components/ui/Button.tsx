...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-slate-900 text-white hover:bg-slate-800 focus-visible:ring-slate-900 dark:bg-slate-700 dark:hover:bg-slate-600",
        primary:
          "bg-slate-900 text-white hover:bg-slate-800 focus-visible:ring-slate-900 dark:bg-amber-600 dark:hover:bg-amber-500",
        secondary:
